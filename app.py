...
RECOMMENDATIONS = {
    ...
    'miedo': [
        "🌬️ Respira profundo. Estás a salvo en este momento presente.",
        "📋 Identifica específicamente qué te preocupa y crea un plan de acción.",
        "👥 Hablar sobre tus miedos puede hacerlos más manejables.",
        "🧠 Recuerda: los pensamientos catastróficos rara vez se cumplen.",
        "💪 Has superado desafíos antes, tienes la fortaleza para esto también."
    ],
    'sorpresa': [
